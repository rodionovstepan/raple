...
#define ASSERT_EQUALS(expected, actual) TEST_ASSERT(expected == actual)
#define ASSERT_NOT_EQUALS(expected, actual) TEST_ASSERT(expected != actual)

#define assertEquals(expected, actual) ASSERT_EQUALS(expected, actual)
#define assertNotEquals(expected, actual) ASSERT_NOT_EQUALS(expected, actual)
#define assertTrue(expression) assertEquals(expression, true)
#define assertFalse(expression) assertEquals(expression, false)
